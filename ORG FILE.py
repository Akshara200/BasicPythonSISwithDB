...
while True:
        if run == 1:
            ...
            c.execute("INSERT INTO student (student_ID,Name,Email,Ph_No,City,Gender,Dept,Year_of_Passing,"
                      "Semester,Grade,Percentage) VALUES (?,?,?,?,?,?,?,?,?,?,?);",
                      (sid, sname, semail, snumber, scity, sgender, sdept, syop, ssem, sgrade, sper))
